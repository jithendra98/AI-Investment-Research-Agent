  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-8">
        <div className="relative w-full max-w-md rounded-2xl border border-border/50 bg-card/50 backdrop-blur-xl p-10 text-center shadow-2xl shadow-cyan-500/5">
          {/* Glow accent */}
          <div className="absolute -inset-px rounded-2xl bg-gradient-to-b from-cyan-500/20 to-transparent opacity-50 pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col items-center gap-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Configuration options will be available in a future version.
            </p>
